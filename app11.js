...
mongoose.connect('mongodb://localhost:27017/gamma2');
...
const storage = multer.diskStorage({
    destination: (req, file, cb) => {
        cb(null, 'C:/Users/yohes/OneDrive/Desktop/WAD Gamma/public/uploads');
    },
...
app.post('/updateCurrentDay', async (req, res) => {
    ...
    try {
        ...
        await Diet.create({ userId, day: cd, calories: 0, username: '' });
